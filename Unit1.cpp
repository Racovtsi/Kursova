...
Image[4] = Image5;
 ...
 //Функція анімації зменшення

__fastcall TForm1::TForm1(TComponent* Owner)
	: TForm(Owner)
{
form2open = TFile::ReadAllText("form2open.txt");
}
//---------------------------------------------------------------------------
...
{
//AnimationUp(imgUp);  //Анімація збільшення
//AnimationDown(imgDown); //Анімація зменшення
